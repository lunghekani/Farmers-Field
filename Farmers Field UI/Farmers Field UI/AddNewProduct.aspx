<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="AddNewProduct.aspx.cs" Inherits="Farmers_Field_UI.AddNewProduct" %>
                 ...
                 <div class="col-md-6 order-md-last d-flex">
                     ...
                     <div  action="#" class="bg-white p-5 contact-form">
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                              <asp:Button type="submit" ID="btnAdd" runat="server" Text="Add" class="btn btn-primary py-3 px-5" OnClick="btnAdd_Click" />
                         </div>
                         ...
                         <div id="addstatus" runat="server">
                            <h5>Not Added, try again! </h5>
                        </div>
